...
import {
  postDineinDataRequest,
  PostRestaurantImageDataRequest,
  PostDeliveryDataRequest,
  PostPickupDataRequest,
  PostKitchenDataRequest,
...
function Stepform() {
  ...
  const outletsteps = [
    {
      ...
      icon: (
        ...
        >
          <path
            d="M11.4524 14.0179C7.19063 14.4032 3.94378 18.0042 4.00036 22.283V22.4999C4.00036 23.3284 4.67194 23.9999 5.50036 23.9999C6.32878 23.9999 7.00036 23.3284 7.00036 22.4999V22.223C6.95527 19.5958 8.89402 17.3555 11.5004 17.023C14.2516 16.7502 16.7031 18.7593 16.9759 21.5105C16.992 21.6732 17.0002 21.8365 17.0003 22V22.4999C17.0003 23.3284 17.6719 23.9999 18.5003 23.9999C19.3288 23.9999 20.0003 23.3284 20.0003 22.4999V21.9999C19.9955 17.5767 16.4057 13.9949 11.9825 13.9998C11.8057 14 11.6288 14.006 11.4524 14.0179Z"
            fill="#2F2F2F"
          />
          <path
            d="M12.0004 12C15.3141 12 18.0004 9.31369 18.0004 6C18.0004 2.68631 15.3141 0 12.0004 0C8.68669 0 6.00037 2.68631 6.00037 6C6.00366 9.31233 8.68805 11.9967 12.0004 12ZM12.0004 3C13.6572 3 15.0004 4.34316 15.0004 6C15.0004 7.65684 13.6572 9 12.0004 9C10.3435 9 9.00037 7.65684 9.00037 6C9.00037 4.34316 10.3435 3 12.0004 3Z"
            fill="#2F2F2F"
          />
        </svg>
      ),
    ...
    },
    {
      ...
      icon: (
        ...
        >
          <path
            d="M18.126 14.2688C16.4579 14.2688 15.1008 15.6259 15.1008 17.294C15.1008 18.9622 16.4579 20.3192 18.126 20.3192C19.7945 20.3192 21.1513 18.9622 21.1513 17.294C21.1513 15.6259 19.7942 14.2688 18.126 14.2688ZM18.126 18.8066C17.2919 18.8066 16.6134 18.1282 16.6134 17.294C16.6134 16.4598 17.2919 15.7814 18.126 15.7814C18.9602 15.7814 19.6387 16.4598 19.6387 17.294C19.6387 18.1283 18.9602 18.8066 18.126 18.8066Z"
            fill="#2F2F2F"
          />
          <path
            d="M7.78993 14.2688C6.12179 14.2688 4.76471 15.6259 4.76471 17.294C4.76471 18.9622 6.12179 20.3192 7.78993 20.3192C9.45807 20.3192 10.8151 18.9622 10.8151 17.294C10.8151 15.6259 9.45807 14.2688 7.78993 14.2688ZM7.78993 18.8066C6.95574 18.8066 6.27732 18.1282 6.27732 17.294C6.27732 16.4598 6.95574 15.7814 7.78993 15.7814C8.62388 15.7814 9.30254 16.4598 9.30254 17.294C9.30254 18.1283 8.62412 18.8066 7.78993 18.8066Z"
            fill="#2F2F2F"
          />
          <path
            d="M20.1633 5.60984C20.0347 5.35447 19.7733 5.19336 19.4874 5.19336H15.5042V6.70597H19.021L21.0804 10.8021L22.4322 10.1224L20.1633 5.60984Z"
            fill="#2F2F2F"
          />
          <path
            d="M15.8571 16.563H10.1345V18.0756H15.8571V16.563Z"
            fill="#2F2F2F"
          />
          <path
            d="M5.52098 16.563H2.89916C2.48141 16.563 2.14288 16.9016 2.14288 17.3193C2.14288 17.737 2.48146 18.0756 2.89916 18.0756H5.52102C5.93877 18.0756 6.27731 17.737 6.27731 17.3193C6.27731 16.9015 5.93873 16.563 5.52098 16.563Z"
            fill="#2F2F2F"
          />
          <path
            d="M23.8412 11.9395L22.3536 10.0235C22.2106 9.83896 21.99 9.73105 21.7563 9.73105H16.2605V4.43695C16.2605 4.0192 15.9219 3.68066 15.5042 3.68066H2.89916C2.48141 3.68066 2.14288 4.01924 2.14288 4.43695C2.14288 4.85465 2.48146 5.19323 2.89916 5.19323H14.7479V10.4873C14.7479 10.9051 15.0865 11.2436 15.5042 11.2436H21.386L22.4874 12.6624V16.5629H20.3949C19.9772 16.5629 19.6386 16.9015 19.6386 17.3192C19.6386 17.737 19.9772 18.0755 20.3949 18.0755H23.2437C23.6614 18.0755 23.9999 17.7369 24 17.3192V12.4034C24 12.2354 23.944 12.0721 23.8412 11.9395Z"
            fill="#2F2F2F"
          />
          <path
            d="M5.47059 12.7312H1.99157C1.57382 12.7312 1.23529 13.0698 1.23529 13.4875C1.23529 13.9052 1.57387 14.2438 1.99157 14.2438H5.47054C5.88829 14.2438 6.22682 13.9052 6.22682 13.4875C6.22687 13.0698 5.88829 12.7312 5.47059 12.7312Z"
            fill="#2F2F2F"
          />
          <path
            d="M7.21008 9.75635H0.756281C0.338578 9.75635 0 10.0949 0 10.5127C0 10.9304 0.338578 11.269 0.756281 11.269H7.21008C7.62783 11.269 7.96636 10.9304 7.96636 10.5127C7.96636 10.095 7.62783 9.75635 7.21008 9.75635Z"
            fill="#2F2F2F"
          />
          <path
            d="M8.44537 6.78149H1.99157C1.57382 6.78149 1.23529 7.12007 1.23529 7.53778C1.23529 7.95553 1.57387 8.29406 1.99157 8.29406H8.44537C8.86312 8.29406 9.20165 7.95548 9.20165 7.53778C9.2017 7.12007 8.86312 6.78149 8.44537 6.78149Z"
            fill="#2F2F2F"
          />
        </svg>
      ),
  ...
  const [outletvisitedSteps, setOutletVisitedSteps] = useState(
    new Array(outletsteps.length).fill(false)
  );
  ...
  const handleSaveandNext = async () => {
    ...
    switch (outletactiveStep) {
      case 0:
        ...
        setpagecounts({ ...pagecounts, Basicdetailsc: 2 });
        ...
        sessionStorage.setItem("Basicdetail", JSON.stringify(Basicdetail));
      ...
      case 1:
        ...
        sessionStorage.setItem("Resimage", JSON.stringify(resimage));
        toast.success("Data Has Been Stored Successfully .");
        break;
      case 2:
        ...
        if (isValid) {
          ...
          setwholecount(wholecount + 1);
          setpagecounts({ ...pagecounts, dineinc: 5 });
          dispatch(postDineinDataRequest(newFormData1));
          let dinein = dineinref.current.getFormData();
          sessionStorage.setItem("Dinein", JSON.stringify(dinein));
          toast.success("Data Has Been Stored Successfully .");
          ...
          toast.error(
            "Please fill out the required fields before moving to the next step"
          );
        }
        break;
      case 3:
        ...
        if (isValid) {
          console.log("pickupcounts",isValid)
          ...
          setwholecount(wholecount + 1);
          setpagecounts({ ...pagecounts, pickupc: 5 });
      ...
      case 4:
        ...
        if (isValid) {
          ...
          setwholecount(wholecount + 1);
          setpagecounts({ ...pagecounts, delivery: 6});
      ...
      case 5:
        ...
        if (isValid) {
          ...
          setpagecounts({ ...pagecounts, kithen: 2 });
          setwholecount(wholecount + 1);
          dispatch(PostKitchenDataRequest(newFormData1));

          sessionStorage.setItem("Kitchen", JSON.stringify(kitchen));
          toast.success("Data Has Been Stored Successfully .");
  ...
  const progress =
    (outletvisitedSteps.filter((step) => step).length / outletsteps.length) *
    100;
