  ...
  const steps = [
    {
      ...
      icon: <svg width="26" height="24" viewBox="0 0 20 22" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    },
    {
      ...
      icon: <svg width="26" height="26" viewBox="0 0 18 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  const handleSaveAndNext = () => {
    ...
    switch (activeStep) {
      case 0:
        ...
        restaurantcount = restaurantDetailsRef.current.getrestaurantcount();
        console.log()
        if (isValid) {
          newFormData = {
            ...newFormData,
            ...
            <div className="sub-containeronboard">
              ...
              <div className="stepper-containeronboard">
                {steps.map((step, index) => (
                  <div
                    key={index}
                    className={`steponboard  ${validSteps[index] ? "valid" : ""} ${visitedSteps[index] ? "visitedonboard" : ""
