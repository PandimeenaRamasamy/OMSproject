    ...
    return (
        <div className="card flex justify-content-center">
            <Stepper ref={stepperRef} style={{ flexBasis: '50rem' }}>
                <StepperPanel header={<div className="custom-header"><i className="pi pi-user"></i><div>Header I</div></div>}>
                ...
                <StepperPanel header={<div className="custom-header"><i className="pi pi-calendar"></i><div>Header II</div></div>}>
                    <div className="flex flex-column h-12rem">
                ...
                <StepperPanel header={<div className="custom-header"><i className="pi pi-check"></i><div>Header III</div></div>}>
                    <div className="flex flex-column h-12rem">
